#!/usr/bin/env python3
"""
Script 243AG — Midline + Consumer Wobble Gate

Two features combined on 243AB-C (double log breathing):

  4. MIDLINE REINTEGRATION: From 237d. midline = 1 + acc × (ARA - 1).
  +  CONSUMER WOBBLE GATE: From 226 v4. ara_distance = max(0, 1-ARA)
     scales Schwabe-frequency wobble on the sawtooth gate accumulator.
     Engines (ARA ≥ 1) get zero wobble.

  DISABLED:
  1. Memory buffer — OFF (using prev_amp only)
  2. Grief bleed — OFF
...
print("=" * 78)
print("Script 243AG — Midline + Consumer Wobble")
print("=" * 78)
print()
...
print(f"\n  {'System':<17} │ {'235b':>7} │ {'243AB-C':>7} │ {'243AG':>7} │ {'Δ vs 235b':>9} │ {'Δ vs AB-C':>9}")
...
print(f"\n  {'System':<17} │ {'Prev LOO':>8} │ {'Best Ever':>9} │ {'243AG LOO':>9} �� "
...
print(f"\n{'=' * 78}")
print("SUMMARY — 243AG Midline Only")
print("=" * 78)
print()
