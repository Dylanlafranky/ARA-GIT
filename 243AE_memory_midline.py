#!/usr/bin/env python3
"""
Script 243AE — Ablation: Memory Buffer + Midline Only

Two of the four engine memory fixes, applied to 243AB-C (double log breathing):
  ...
  DISABLED:
  2. Grief bleed — OFF (using original instant correction from 235b)
  3. ARA-dependent momentum — OFF (using hardcoded 0.3)
"""
...
print("=" * 78)
print("Script 243AE — Ablation: Memory Buffer + Midline Only")
print("=" * 78)
print()
print("  Fix 1: Gleissberg memory buffer (φ-decaying rolling average)  ← ON")
print("  Fix 2: Grief bleed                                           ← OFF (instant)")
print("  Fix 3: ARA-dependent momentum                                ← OFF (hardcoded 0.3)")
...
print(f"\n{'=' * 78}")
print("SUMMARY — 243AE Memory Buffer + Midline")
print("=" * 78)
print()
