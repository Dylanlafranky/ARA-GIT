...
downloaded data. REPLICATED same day on the author's own hardware, independent
environment/download: every statistic digit-identical (n=949/17305; MW p=5.658e-08;
Pearson −0.347; matched Wilcoxon p=8.846e-43; partial −0.203).** Supplements `EnergyRatio/GOLDEN_STARS_LEAN_RESULT.md`; confirms and extends
