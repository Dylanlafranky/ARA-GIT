#!/usr/bin/env python3
"""Reproduce the staged Q22 selective extraction from the Willow ZIP."""
...
PREFIX = "google_105Q_surface_code_d3_d5_d7/d5_at_q6_9"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Run geometry, freeze Q22, and only then run outcomes.",
    )
    stage = parser.parse_args().stage
    selected = GEOMETRY_MEMBERS if stage == "geometry" else OUTCOME_MEMBERS
    write_stage(stage, selected)
