"""Download, verify and extract the frozen Q44 public target archive."""
...
OUT = HERE / "public_data" / "q44_mixing_inhomo_v1_mimic"
NAME = "unnati_submit_12_inhomo_v1_mimic.hdf5.zip"
HDF_NAME = "unnati_submit_12_inhomo_v1_mimic.hdf5"
URL = f"https://zenodo.org/records/16753415/files/{NAME}?download=1"
EXPECTED_MD5 = "08b2eaa89268952f7e197eecb2ea9610"
...
def download() -> pathlib.Path | None:
    ...
    while not destination.exists():
        ...
        request = urllib.request.Request(
            URL,
            headers={
                "User-Agent": "ARA-Q44-reproduction/1.0",
        ...
        with urllib.request.urlopen(request, timeout=180) as response:
            ...
            if status != 206 or match is None:
                raise RuntimeError(
                    "Server did not honor frozen range request: "
