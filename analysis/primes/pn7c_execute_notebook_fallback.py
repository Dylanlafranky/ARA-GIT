...
NOTEBOOK = HERE / "PN7C_ACTUAL_GAP_SEQUENTIAL_MEMORY.ipynb"
VALIDATION = HERE / "PN7C_NOTEBOOK_EXECUTION_VALIDATION.json"
...
def main() -> None:
    ...
    total = sum(cell["cell_type"] == "code" for cell in notebook["cells"])
    notebook["metadata"]["pn7c_execution"] = {
    ...
    report = {
        ...
        "errors": errors,
        "complete": not errors and executed == total,
