#!/usr/bin/env python3
"""
Script 243AZ — Wave Physics Combo: Mode Coupling + Standing Wave

Based on 243AJ champion (Solar LOO 42.89).

Combines the two successful wave physics additions:

  1. MODE COUPLING (from 243AW-v2): Inverse cascade — short-period harmonics
     transfer 1/φ⁹ of their energy to the next-longer rung. "Larger waves
     eating smaller waves." Inserted after tension loop, before shape assembly.

  2. STANDING WAVE (from 243AX-v3): Zero-centered envelope between singularity
     walls at 0 and 2. sin(π×ARA/2) with home subtracted so modulation is zero
     at equilibrium. Highest correlation ever (0.438). Inserted after shape
     assembly, before grief.

Individual results:
  - Mode coupling alone:  LOO 45.75 (Δ = +2.86 vs champion)
  - Standing wave alone:  LOO 44.10 (Δ = +1.21 vs champion)
  - Champion (243AJ):     LOO 42.89

Question: do they stack constructively or destructively?
"""
...
class EngineMemoryNode(OrigARANode):
    ...
    def cascade_shape(self, t):
        ...
        # ── MODE COUPLING: inverse cascade — long periods eat short ──
        ...
        # ── STANDING WAVE: zero-centered envelope between singularities ──
...
print(f"\n{'=' * 78}")
print("SUMMARY — 243AZ Wave Combo (Mode Coupling + Standing Wave)")
print("=" * 78)
print()
