#!/usr/bin/env python3
"""
Script 243AX — Standing Wave Envelope
...
class EngineMemoryNode(OrigARANode):
    ...
    def cascade_shape(self, t):
        ...
        # ── STANDING WAVE ENVELOPE v3: zero-centered excursion ──
        # Standing wave sin(π×ARA/2) between singularity boundaries.
        # Zero-centered: subtract home ARA's standing weight so the
        # modulation is zero at equilibrium and only activates during
        # ARA excursions. Moving toward clock (antinode) amplifies;
        # moving toward singularities damps.
...
print("=" * 78)
print("Script 243AX — Standing Wave Envelope")
print("=" * 78)
print()
...
print("  NEW:   Standing wave envelope sin(π×ARA/2) at 1/φ⁴ strength  ← ON")
print()
...
print(f"\n{'=' * 78}")
print("SUMMARY — 243AX Standing Wave Envelope")
print("=" * 78)
print()
