"""
llm_capture_raw_for_clean_ARA.py  — RUN ON A GPU (Google Colab).
...
SIZES = [
    ...
    # add more later by deleting the leading "# ":
...
OUT_CSV = "llm_closure_RESULTS.csv"
OUT_NPZ = "llm_raw_node_series.npz"
