"""
llm_whole_run_octave_sweep.py  — RUN ON A GPU (Google Colab).
...
SIZES = [
    ...
    # after it works, delete the "# " to add the bigger one (slower, more to download):
...
OUT_CSV = "llm_closure_WHOLE_RUN.csv"
OUT_NPZ = "llm_raw_node_series_WHOLE_RUN.npz"
